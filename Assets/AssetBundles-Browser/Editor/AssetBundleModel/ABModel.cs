...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    public static class Model
    {
        ...
        static private Texture2D s_texture2dIcon = null;
        static private Texture2D s_textassetIcon = null;
        static private Texture2D s_shaderIcon = null;
        static private Texture2D s_fontIcon = null;
        static private Texture2D s_shaderVaroantsIcon = null;
        static private Texture2D s_audioclipIcon = null;
        static private Texture2D s_materialIcon = null;
        static private Texture2D s_animationcliplIcon = null;
        static private Texture2D s_animationctrIcon = null;
        ...
        internal static string[] ValidateBundleList()
        {
            ...
            var bundleSet = new HashSet<string>(bundleList);
            if (bundleSet.Count == bundleList.Length) return bundleList;

            bundleSet.Clear();
            var valid = true;
            var index = 0;
            //var attemptedBundleReset = false;
...
#if false
{
        ...
        private static BundleInfo AddBundleToModel(string name)
        {
            ...
            var nameData = new BundleNameData(name);

            var folder = AddFoldersToBundle(s_RootLevelBundles, nameData);
            var currInfo = AddBundleToFolder(folder, nameData);
        ...
        {
            var currInfo = root.GetChild(nameData.shortName);
            if (!string.IsNullOrEmpty(nameData.variant))
            {
                ...
                if (folder == null)
                {
                    ...
                    message += " exists both as a standard bundle, and a bundle with variants.  This message is not supported for display or actual bundle building.  You must manually fix bundle naming in the inspector.";
                    LogError(message);
                    return null;
                }
        ...
        static internal Texture2D GetIconByAssetType(BundleDataInfo.AssetType varType)
        {
            if (s_bundleIcon == null)
                FindBundleIcons();
            switch (varType)
            {
                case BundleDataInfo.AssetType.GameObject:
                default:
                    return s_bundleIcon;
                case BundleDataInfo.AssetType.SceneAsset:
                    return s_sceneIcon;
                case BundleDataInfo.AssetType.TextAsset:
                    return s_textassetIcon;
                case BundleDataInfo.AssetType.Texture2D:
                    return s_texture2dIcon;
                case BundleDataInfo.AssetType.Shader:
                    return s_shaderIcon;
                ...
                case BundleDataInfo.AssetType.Material:
                    return s_materialIcon;
                case BundleDataInfo.AssetType.AnimationClip:
                    return s_animationcliplIcon;
                case BundleDataInfo.AssetType.AnimatorController:
                    return s_animationctrIcon;
            }
        }
        static private void FindBundleIcons()
        {
            s_folderIcon = EditorGUIUtility.FindTexture("Folder Icon");
            s_bundleIcon = Resources.Load<Texture2D>("ABundleBrowserIconY1756Basic");
            s_sceneIcon = Resources.Load<Texture2D>("ABundleBrowserIconY1756Scene");
            s_texture2dIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_Texture");
            s_textassetIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_TextAsset");
            s_shaderIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_Shader");
            s_fontIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_Font");
            s_shaderVaroantsIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_ShaderVariants");
            s_audioclipIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_AudioClip");
            s_materialIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_Material");
            s_animationcliplIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_AnimationClip");
            s_animationctrIcon = Resources.Load<Texture2D>("ABundleBrowserIcon_AnimatorController");
        }
    }
}
